...
let IngestController = class IngestController {
    ...
    async ingestUrl(body) {
        return this.ingest.ingestSingleUrl(body.url, body.namespace, body.documentType ?? "webpage");
    }
    async ingestUrls(body) {
        return this.ingest.ingestManyUrls(body.urls, body.namespace, body.documentType ?? "webpage");
    }
};
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], IngestController.prototype, "ingestUrls", null);
